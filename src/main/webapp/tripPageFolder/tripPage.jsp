...
<head>
  ...
  <link rel="stylesheet" href="tripPageFolder/tripPage.css" />
</head>
<body>
  <header class="header">
...
<section class="card total">
  ...
  <button onclick="redirectToPaymentPage()" class="pay-now-btn">Pay Now</button>
</section>
    ...
    <script src="tripPageFolder/tripPage.js"></script>
